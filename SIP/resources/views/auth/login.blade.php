...
<body cz-shortcut-listen="true">
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="/concept/index.html"><img class="logo-img" src="/concept/assets/images/logo.png" alt="logo"></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form method="post" action="{{ url('/login') }}">
                    ...
                    @if ($message = Session::get('success'))
                        <div class="card bg-secondary text-white">
                            <div class="card-body">
                                <h4 class="text-white"><i class="fas fa-ban"></i> WARNING</h4>
                                <p>{{ $message }}</p>
                            </div>
                        </div>
                    @endif
